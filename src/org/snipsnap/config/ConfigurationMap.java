 ...
 * @see Configuration
 * @version $Id: ConfigurationMap.java,v 1.24 2004/05/17 10:56:17 leo Exp $
 */
public class ConfigurationMap {
  ...
  public void storeGlobals(OutputStream stream) throws IOException {
    ConfigurationMap.globals.store(stream, "SnipSnap Globals Configuration $Revision: 1.24 $");
  }
  ...
  public void store(OutputStream stream) throws IOException {
    properties.store(stream, "SnipSnap Configuration $Revision: 1.24 $");
  }
